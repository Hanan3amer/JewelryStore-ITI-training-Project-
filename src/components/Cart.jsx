...
export default function Cart() {
  ...
  let { cartItems, addToCart, removeFromCart, total, decrementQuantity } = useContext(CartContext);
  ...
  return (
    <div className="container my-5">
      ...
      <div className="row">
        {cartItems.length > 0 ? (
          cartItems.map((item) => (
            <div className="col-md-12 d-flex justify-content-between align-items-center border-bottom py-3" key={item.id}>
